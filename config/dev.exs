...
config :invoice_goblin, InvoiceGoblinWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "PQRVEagsivuzv+0sXnvn10MegGKs9lzj4Hk7cKh0hFhoHeB9dn7oP+sLKscfuiXh",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:invoice_goblin, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:invoice_goblin, ~w(--watch)]}
  ]
