...
config :invoice_goblin, InvoiceGoblinWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: InvoiceGoblinWeb.ErrorHTML, json: InvoiceGoblinWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: InvoiceGoblin.PubSub,
  live_view: [signing_salt: "FlOXTV5P"]
...
config :invoice_goblin, InvoiceGoblin.Mailer, adapter: Swoosh.Adapters.Local
...
config :ex_cldr,
  default_locale: System.get_env("LOCALES_PRIMARY") || "en",
  default_backend: InvoiceGoblinCldr
