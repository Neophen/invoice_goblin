...
#
#     PHX_SERVER=true bin/invoice_goblin start
#
...
if config_env() == :prod do
  ...
  config :invoice_goblin, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :invoice_goblin, InvoiceGoblin.Mailer,
